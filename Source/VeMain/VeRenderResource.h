...
class VE_MAIN_API VeRenderResource : public VeRefObject
{
	VeNoCopy(VeRenderResource);
	VeRTTIDecl(VeRenderResource);
public:
	enum Dimension
	{
		DIMENSION_UNKNOWN = 0,
...
protected:
	...
	Dimension m_eDimension;

};

VeSmartPointer(VeRenderResource);
