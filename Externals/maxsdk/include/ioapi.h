...
public:
	...
	PostLoadCalls with a higher Priority may be replaced by the Priority 6 PostLoadCall. PostLoadCalls with a priority 
	less than 0 will be treated as 0, greater than 10 will be treated as 10. */	
...
public:
	...
	IOResult Write(const UINT64 *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
...
public:
	...
	*/
	...
	// TODO: When the SDK breaks, de-inline this function
...
//@{
#define I_EXEC_ILOAD_PERFORMING_SCENE_LOAD 1 //!< Execute method returns true if performing a scene file load, false otherwise (merge, mtl lib load, etc).
//@}
...
public:
	...
	IOResult Read(const UINT64 *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
