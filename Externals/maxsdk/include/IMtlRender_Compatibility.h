...
inline void IMtlRender_Compatibility_MtlBase::Init(ClassDesc& classDesc) {
	...
	LoadDescriptor(IMTLRENDER_COMPATIBILITY_MTLBASE_INTERFACEID, _M("IMtlRender_Compability_MtlBase"), 0, &classDesc, 0, p_end);
}
...
inline void IMtlRender_Compatibility_Renderer::Init(ClassDesc& classDesc) {
	...
	LoadDescriptor(IMTLRENDER_COMPATIBILITY_RENDERER_INTERFACEID, _M("IMtlRender_Compability_Renderer"), 0, &classDesc, 0, p_end);
}
